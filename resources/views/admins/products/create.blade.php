        ...
        <div class="card-body">
            <form method="post" action="{{ route('product.save') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="priceDefault" class="form-control">
                </div>
                <div class="form-group">
                    <label for="">Price Sell<span class="text-danger"></span></label>
                    <input type="number" name="priceSell" class="form-control">
                </div>
                <div class="form-group">
                ...
                <button class="btn btn-primary">Add To Product List</button>
            </form>
        </div>
    </div>
</div>
